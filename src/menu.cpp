...
int main(int argc, char **argv){
	...
	string title_1 = " ____                     _       ______                               ";
	string title_2 = "|  _ \\                   | |     |  ____|                              ";
	string title_3 = "| |_) |  ___   _ __ ___  | |__   | |__    ___   ___  __ _  _ __    ___ ";
	string title_4 = "|  _ <  / _ \\ | '_ ` _ \\ | '_ \\  |  __|  / __| / __|/ _` || '_ \\  / _ \\";
	string title_5 = "| |_) || (_) || | | | | || |_) | | |____ \\__ \\| (__| (_| || |_) ||  __/";
	string title_6 = "|____/  \\___/ |_| |_| |_||_.__/  |______||___/ \\___|\\__,_|| .__/  \\___|";
	string title_7 = "                                                          | |          ";
	string title_8 = "                                                          |_|";
		...
		switch(choice){
			case KEY_UP:
				switch(pos){
					case 0:
						wattron(win, A_BOLD);
						mvwprintw(win, centerYArray[pos], centerXArray[pos], opArray[pos].c_str());
						wattroff(win, A_BOLD);
						pos = 3;
						wattron(win, A_STANDOUT);
						mvwprintw(win, centerYArray[pos], centerXArray[pos], opArray[pos].c_str());
